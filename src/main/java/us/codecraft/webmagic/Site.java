...
import us.codecraft.webmagic.proxy.DefaultProxyPool;
...
//        result = 31 * result + (userAgent != null ? userAgent.hashCode() : 0);
    ...
    public Site setHttpProxyPool(List<String[]> httpProxyList, boolean isUseLastProxy) {
        this.httpProxyPool=new DefaultProxyPool(httpProxyList, isUseLastProxy);
        return this;
    }

    public Site enableHttpProxyPool() {
        this.httpProxyPool=new DefaultProxyPool();
        return this;
    }
