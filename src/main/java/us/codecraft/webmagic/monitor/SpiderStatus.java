...
public class SpiderStatus implements SpiderStatusMXBean {
    ...
    public int getLeftPageCount() {
        ...
        logger.info("Get leftPageCount fail, try to use a Scheduler implement MonitorableScheduler for monitor count!");
        return -1;
    }
    ...
    public int getTotalPageCount() {
        ...
        logger.info("Get totalPageCount fail, try to use a Scheduler implement MonitorableScheduler for monitor count!");
        return -1;
    }
